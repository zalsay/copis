  ...
  theme: {
    extend: {
      ...
      borderRadius: {
        ...
        lg: 'var(--radius)',
        xl: 'calc(var(--radius) + var(--radius-xl-extra, 0px))',
        '2xl': 'calc(var(--radius) + var(--radius-2xl-extra, 0px))',
        card: 'var(--radius-card, var(--radius))',
        dialog: 'var(--radius-dialog, var(--radius))',
        modal: 'var(--radius-modal, var(--radius))',
      },
