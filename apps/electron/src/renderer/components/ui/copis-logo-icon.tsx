/**
 * CopisLogoIcon - Copis 品牌双环矢量图标组件
 *
 * 采用最新的 Copis 品牌双环矢量路径，支持 className、size、fill 与任意 SVGProps。
 * 默认以 fill="currentColor" 填充，可无缝替换项目中使用的 Sparkles 图标。
 */

import * as React from 'react'

export interface CopisLogoIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string
}

export const CopisLogoIcon = React.forwardRef<SVGSVGElement, CopisLogoIconProps>(
  ({ size = 16, width, height, className, fill = 'currentColor', ...props }, ref) => {
