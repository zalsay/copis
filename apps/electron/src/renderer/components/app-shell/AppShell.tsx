...
export function AppShell({ contextValue }: AppShellProps): React.ReactElement {
  ...
  const showRightPanel = appMode === 'agent' && !!currentSessionId && !workingHistorySelection && !automationForm.open && activeView !== 'planning' && activeView !== 'agent-skills' && activeView !== 'memory'
