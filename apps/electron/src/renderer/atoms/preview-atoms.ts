...
/** 分栏比例（对话占比），持久化 */
export const previewSplitRatioAtom = atomWithStorage<number>('copis-preview-split-ratio', 0.5, undefined, { getOnInit: true })
