...
interface ActiveRun { invocation: ChatRoomAgentInvocation; config: ChatRoomAgentLocalConfig; stopRequested: boolean; terminal: boolean; completionClaimed: boolean; lastDeltaAt: number; sessionRelease?: () => void }
